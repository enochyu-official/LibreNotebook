...
\newtheoremstyle{listprobstyle}
    ...
    {}
    { }
    {{\thmnumber{#2}.}~\thmnote{\textcolor{BrickRed}{\bfseries #3}}\\}
...
\theoremstyle{listprobstyle}
\newtheorem{listproblem}{}[section]
\newenvironment{proofInBox}
...
\newtcbtheorem[no counter]{basicboxstyleSolution}{}{%
    titlebox=invisible,
    detach title,
    colframe=bg,
    colback=bg,
...
\newenvironment{basicboxSolution}
{\begin{basicboxstyleSolution}{}{}}{\end{basicboxstyleSolution}}
...
\newenvironment{cppboxSolution}
{\begin{cppboxstyleSolution}}{\end{cppboxstyleSolution}}
...
\newenvironment{outputboxSolution}
{\begin{outputboxstyleSolution}{}{}}{\end{outputboxstyleSolution}}
...
\newcommand{\easy}{(\ensuremath{\bullet \circ \circ})}
\newcommand{\medium}{(\ensuremath{\bullet \bullet \circ})}
\newcommand{\hard}{(\ensuremath{\bullet \bullet \bullet})}
