...
\begin{cppbox}{CS0201.26050-01}{CS0201.26050-01}
...
Now let's break down the program line by line. First, \verb|#include|
\newline \verb|<iostream>| is for including the standard input and
...
\begin{cppbox}{CS0201.26050-02}{CS0201.26050-02}
\begin{lstlisting}[style=cppstyle]
#include <iostream>
using namespace std;
...
\begin{cppbox}{CS0201.26050-03}{CS0201.26050-03}
\begin{lstlisting}[style=cppstyle]
#include <iostream>
...
\begin{cppbox}{CS0201.26050-04}{CS0201.26050-04}
\begin{lstlisting}[style=cppstyle]
#include <iostream>
...
\begin{cppbox}{CS0201.26050-05}{CS0201.26050-05}
\begin{lstlisting}[style=cppstyle]
#include <iostream>
...
One more thing to keep in mind about inputs is that some competitions
and older USACO takes file as an input. In that case, we can do the
same by using this template.
