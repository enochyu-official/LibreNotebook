...
= \frac{n}{n + 1}
\end{align*}
Below is another classic problem with an interesting property.
\begin{problem}{}{}
...
\end{problem}
\begin{proof}
Consider the identity $\frac{1}{k(k + 1)} = \frac{1}{k} -
\frac{1}{k + 1}$ for $k \neq 0, -1$. Expanding, the following
inequalities are obtained.
\begin{align*}
    \frac{1}{1^2} + \frac{1}{2^2} + \cdots + \frac{1}{n^2}
    &< 1 + \frac{1}{1 \cdot 2} + \cdots + \frac{1}{(n - 1) \cdot n} \\
    &= 1 + \left( \frac{1}{1} - \frac{1}{2} \right) + \cdots
...
\begin{problem}
{2007 Belarusian MO Final Problem 2 \easy}
{2007 Belarusian MO Final Problem 2}
...
\begin{align*}
    ...
    &= 4 \left\{ (1 - a_1) + (a_1 - a_1 a_2) + \cdots \right. \\
...
* Substitution, uvw method, Ravi Transformation
* Fudging, Smoothing, and Ordering
* Super-Sums of Square-Weights (SOS)
* Majorization Theory
* Mixing Variables
