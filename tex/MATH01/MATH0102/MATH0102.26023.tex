...
relationship between objects and their projections. Many foundational
concepts including parallelism and transformation significantly
differs too. Before we get into some important theorems and topics,
lets discuss some of its foundational properties to get the gut
feeling for future topics.

First, consider the two, not necessarily similar, triangles and
a point $P$.
...
$\triangle{A'B'C'}$, and we say that $A', B', C'$ are corresponding
points of $A, B, C$ respectively. Similarly, we could state that
$\overline{A'B'}, \overline{B'C'}, \overline{C'A'}$ are corresponding
sides of $\overline{AB}, \overline{BC}, \overline{CA}$ respectively.
With this projection in mind, let's discuss some fundamental theorems
...
like Desargues' Theorem and Pascal's Theorem.
